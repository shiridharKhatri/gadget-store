...
const Home = () => {
  ...
  const categoryItems = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1544117519-31a4a39819a0?auto=format&fit=crop&w=500&q=60",
      icon: <Watch size={20} />,
      slug: "smartwatches",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1546435770-a3e426bf472b?auto=format&fit=crop&w=500&q=60",
      icon: <Music size={20} />,
      slug: "headphones",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1601524909162-ae8725290836?auto=format&fit=crop&w=500&q=60",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1558002038-1055e2e28ed1?auto=format&fit=crop&w=500&q=60",
  ...
  const nextCategory = () => {
    ...
    if (scrollLeft + visibleWidth >= scrollWidth) {
      ...
      setCurrentCategorySlide((prev) =>
        prev < categoryItems.length - 1 ? prev + 1 : prev
      );
    }
  };
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Discover our collection of premium audio devices designed to
              transform your listening experience with cutting-edge technology
            ...
            {categoryItems.map((_, index) => (
              <div
                ...
                className={`slider-dot ${
                  index === currentCategorySlide ? "active" : ""
                }`}
          ...
          <div className="deal-card">
            <div className="deal-content">
              ...
              <p className="deal-description">
                ...
                and 24-hour battery life. Limited stock available.
              </p>
        ...
        <div className="container">
          <div className="testimonials-header">
            ...
            <p>
              ...
              audio experience with TechWave
            </p>
          </div>
